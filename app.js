...
var Image = function(id,e, n,u,w,h,a,c,t,tw,th) {
    return {
        "id": id,
        "ext": e,
        "name": n,
...
var readDir = (dirPath) => {
    return fs.readdirSync(dirPath).reduce((list, file) => {
        ...
        if(ext === '.mp4') {
            var img = new Image(cnt++, ext.substring(1), file, "../data/images/" + file, 0, 0, 0, stats.ctime.toISOString(), "../data/thumbs/" + file, 200, 200);
        ...
        var img = new Image(cnt++, ext.substring(1), file, "../data/images/" + file, size.width, size.height, aspect, stats.ctime.toISOString(), "../data/thumbs/" + file, tsize.tw, tsize.th);
